...
const nameplates: Array<Nameplate> = [
    new Nameplate(
        "熵锁锚核", 
        "冰层下冻结着偷盗时间的恶魔，永眠者的呼吸凝成秩序的牢笼", 
        "生成绝对零度防火墙，将数据攻击冻结成无害冰晶", 
        "这块冰晶打造的铭牌内封存着麦克斯韦妖算法原型，能在量子层面建立数据负熵屏障。其原型来自21世纪某位匿名密码学家遗留在极地科考站的草稿纸，当观测站发现北极圈数据熵值曲线与冰川消融速度完全吻合时，终于破解了这份用啤酒渍书写的微分方程。佩戴者可在半径十公里内形成密码沙盒，将黑客攻击转化为无害的雪花代码。",
        "<p>北极冰川深处，你跪在坍塌的量子观测站废墟上。暗焰组织留下的数据病毒正在啃噬服务器，冰层裂缝中渗出荧光的熵增黏液。头盔投影显示这里埋着初代守林人封存的锚核，但每靠近一步，虚拟界面的温度计就暴跌十度。</p><p>你突然意识到，真正的密钥是「静止」——当暗焰的蠕虫代码扑来时，你切断所有能源主动冻结自己。绝对寂静中，冰层裂开蛛网纹路，一枚冰蓝色六棱柱缓缓升起。那些病毒撞上铭牌瞬间凝成雪屑，飘向天际化作极光。</p>",
        2
    ),
    new Nameplate(
        "极光棱镜",
        "破碎的镜子预言了第七次日落，凝视深渊者终将成为星空拼图",
        "折射数据污染轨迹，标记暗焰藏身坐标",
        "刻有十六重虹膜的银质圆盘，其原型是格陵兰岛原住民用陨铁打造的星象观测器。第3代守林人在冰芯里发现了它的量子纠缠特性——当虚拟碳排放超标时，表面会浮现极光构成的预警图腾。升级后的铭牌能通过瞳孔生物密码激活，在元宇宙投射出笼罩整个北半球的北极星坐标网，精准定位暗焰组织的数据污染源。",
        "<p>格陵兰冰洞内，暗焰制造的虚假极光正在诱骗科考无人机坠毁。你贴着洞壁爬行，手中辐射仪因棱镜的能量脉冲疯狂跳动。突然脚下冰层塌陷，你坠入二十米深的冰井——这里竟藏着二十二世纪的极地天文台遗址。</p><p>全息星图在头顶旋转，棱镜就嵌在坍塌的射电望远镜焦点处。但每次伸手触碰，棱镜就会分裂成七个重影。你想起谜语中的「第七次日落」，将防护服切换到黄昏光谱模式。当第七道橙光扫过时，所有幻影坍缩成实体，棱镜边缘浮现出暗焰老巢的经纬度。</p>",
        3
    ),
    new Nameplate(
        "雷蚀龙芯",
        "撕裂夜幕的雷霆囚禁在青铜瞳孔，被诅咒的刀刃以背叛者的鲜血开刃",
        "释放数据链闪电，逆向腐蚀暗焰核心服务器",
        "由火山黑曜石与液态金属融合而成，表面布满龙鳞状电路纹，因过量吸收火山辐射产生变异。当暗焰组织试图用虚拟岩浆污染地壳数据时，铭牌会从地幔层召唤等离子闪电，这些闪电能顺着敌方数据链回溯烧毁主机芯片。曾有三名守林人在接触它时被反噬，付出了生命的代价发现必须以自身血液激活龙瞳——每道闪电都将携带攻击者的基因密码，确保力量永不失控。",
        "<p>勘察加火山口的岩浆湖沸腾着暗红色代码，这是暗焰组织用伪造的碳排放交易数据生成的虚拟熔岩。你穿着反射护甲沿火山壁下滑，手中探测仪显示龙芯嵌在湖心黑色结晶柱里。十二台机械守卫突然苏醒，它们的激光束扫过处岩浆炸起十米高。</p><p>你冒险跳入岩浆，护甲在高温中剥离成纳米虫群。当赤裸的右手抓住龙芯时，那些岩浆突然凝固成紫黑色晶体——铭牌在吸收整座火山的算力。机械守卫的炮口调转对准自己，它们的钢铁身躯爬满枝状闪电，最终连同火山服务器一起坍缩成焦黑的硅化木。</p>",
        4
    ),
    new Nameplate(
        "时溯沙漏",
    ...
    new Nameplate(
        "星火燧芯",
        "熄灭的陨石里住着偷火种的贼，灰烬中站起的盗火者点燃了黄昏",
        "焚烧数据垃圾转化为清洁量子能",
        "燃烧着永恒火焰的玄武岩芯片，内核储存着人类最早的火种基因序列。22世纪清洁能源联盟曾试图用它构建碳中和区块链，却在核聚变实验事故中沉入马里亚纳海沟。重启后的铭牌能在量子服务器底层引燃“文明篝火”，将数据垃圾煅烧成可降解的二进制孢子，其释放的虚拟热能可反哺现实世界的冻土带。",
        "<p>马里亚纳海沟底部，被暗焰改造成垃圾焚化炉的深海基地正喷发黑烟。你驾驶潜水器冲破剧毒热泉，机械臂抓住岩缝中半融化的燧芯。突然警报炸响——暗焰启动了自毁程序，岩壁渗出沥青状的数据污染物，将你困在直径三米的沸腾气泡里。</p><p>你抡起液压锤砸向燧芯表面的玄武岩外壳，火星迸溅的刹那，铭牌突然吸入周围所有热能。海水极速结冰，黑烟凝成雪花簌簌坠落。舱内屏幕亮起提示：「文明之火需以绝望为引」。</p>",
        6
    ),
    new Nameplate(
        "血棘菌脉",
        "吮吸战死者骨髓的藤蔓开出铁锈花，被埋葬的兵器在菌丝里长出毒牙",
        "向暗焰的数据流注入生物病毒",
        "一截嵌着弹片的猩红菌丝，其源头可追溯至冷战时期生物实验室泄露的纳米武器。这些菌种以重金属和电磁波为食，在刚果雨林深处与军用AI结合成共生体。当植入敌方服务器时，菌丝会伪装成防火墙迅速增殖，其孢子携带的朊病毒能扭曲数据编码逻辑——被攻击的系统将不断“生长”出无效代码，如同癌细胞般自我吞噬。",
        "<p>暗焰在刚果盆地培育的杀人藤突然变异，你追踪到这些植物根须竟在吞噬5G基站。砍开一株直径三米的血色巨菌，内部涌出带着军用编码的孢子云。你被迫吸入部分孢子，左手瞬间木质化并长出尖刺。</p><p>幻觉中看到纳粹1943年在此埋藏的生化武器资料库，那些腐烂的档案正通过菌丝上传到暗焰服务器。你用木质化的左手插入菌盖，强行进行神经连接。当痛觉达到临界值时，整片菌林突然向你跪拜——它们把携带致命程序的孢子注入你体内，而你反将孢子群改造为铭牌载体。</p>",
        7
    ),
    new Nameplate(
        "鲸墟鸣匣",
        "沉默的鲸骨在海底搭建通天巴别塔，溺亡文明的声带震碎了时空的琥珀",
        "重启地球-元宇宙共生协议",
        "嵌有抹香鲸耳骨化石的青铜装置，记录着海洋哺乳动物千万年进化的声波密码。22世纪元宇宙基建过度抽取海水冷却量子服务器，致使鲸群集体搁浅自杀。守林人从它们颅腔内的磁性晶体提取出“生命冗余编码”，当所有铭牌齐聚时能发出跨维度的鲸歌脉冲，在虚实交界处重构碳基与硅基文明的共生契约。",
        "<p>东京湾海底，暗焰用次声波武器驱赶着机械虎鲸群。你穿着抗压服潜入核电站废墟，鸣匣卡在反应堆燃料棒之间，表面附着的贝类生物正发出诡异频率的声波。每靠近一米，耳膜就渗出鲜血，AR界面显示这是鲸类文明最后的悲鸣。</p><p>你摘下翻译器直接用骨传导接收声波，颅腔共振的剧痛中竟听懂了旋律——那是抹香鲸用二十年寿命编写的密码。跟着旋律节拍游动，机械虎鲸突然调头为你开路。握住鸣匣的瞬间，所有鲸鱼机械体同时抬头，向海面射出蔚蓝的光柱。</p>",
        8
    )
]
        ...
        <div class="accordion-item" id="backstory">
            ...
            <div id="collapseForBackstory" class="accordion-collapse collapse" aria-labelledby="accordionHeadingForBackstory" data-bs-parent="#mainAccordion">
                <div class="accordion-body">
                    ...
                    <p>人类最后的希望藏在七块神秘铭牌中，你需要拿到这七块铭牌，拯救地球。</p>
                </div>
            </div>
        </div>
